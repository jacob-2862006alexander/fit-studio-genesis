...
const Index = () => {
  ...
  const features = [{
    ...
    description: "Open early morning to late night"
  }];
  const stats = [{
    number: "500+",
    label: "Happy Members"
  ...
  const testimonials = [{
    name: "Sarah M.",
    rating: 5,
    text: "FitStudio changed my life! The trainers are amazing and the community is so supportive."
  }, {
    name: "Mike R.",
    rating: 5,
    ...
    name: "Lisa K.",
    rating: 5,
    text: "Love the variety of classes. There's something for everyone here!"
  }];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-primary hover:bg-white/90 text-lg px-8 py-6" onClick={() => setJoinModalOpen(true)}>
                Start Your Journey
              </Button>
              <Button size="lg" variant="outline" className="border-white hover:bg-white/10 text-lg px-8 py-6 text-gray-900">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            time: "60 min",
            difficulty: "Beginner",
            description: "Gentle movements for flexibility and peace"
          }, {
            name: "Strength Training",
            time: "50 min",
            difficulty: "Intermediate",
            description: "Build muscle with expert guidance"
          }].map((cls, index) => <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-accent text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button size="lg" className="bg-white text-primary hover:bg-white/90 text-lg px-8" onClick={() => setJoinModalOpen(true)}>
              Join Now
            </Button>
